...
// //         const code = await getLocationCode(locationInputName);
...
// //         const forecastDivElement = document.getElementById('forecast');
// //         forecastDivElement.style.display = 'inline';
// //         forecastDivElement.style.visibility = 'visible';
// //      } catch (error) {
// //          alert('Error');
...
// async function getLocationCode(locationInputName){
//     const url = 'http://localhost:3030/jsonstore/forecaster/locations';

//     const res = await fetch(url);
//     const data = await res.json();

//     const searchedLocation = data.find(l => l.name === locationInputName);

//     return searchedLocation.code;
// }
